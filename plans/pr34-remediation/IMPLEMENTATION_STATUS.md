...
Current resume point (2026-09-23): feeb14d committed and pushed (production multiplex), following8e7888a (effective controls and capture isolation). Windows31/Linux31 multiplex/lifecycle tests PASS; additional90 PASS; real Codex0.156.1 multiplex1 PASS. Surface49/identity16/schema056. Full Windows suite on feeb14d now RUNNING via exec session15489; poll that handle, do not restart from an observation timeout. Native campaign flags removed and legacy live flags zero. The wrapper writes redacted evidence/p12-suite-feeb14d.json on completion; raw XML stays in its unique temporary directory. Do not edit implementation/tests until this immutable-code suite finishes. Broader effective capabilities, cutover/backup and remaining P12 gates remain pending. Pi and dedicated attach native NOT_RUN. Final gate NOT PASSED.
