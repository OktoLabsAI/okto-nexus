...
Current resume point (2026-09-23): parent82f7c77 pushed; effective control contracts and durable capture isolation milestone in progress above it. Surface48/identity15/schema056. Unknown native versions cannot steer/interrupt; Pi gets a bounded version observation. A real Codex NativeEventOverflow exposed synchronous SQLite projection blocking native capture; capture now fsyncs independently and the existing owner projects bounded atomic batches. Windows38/Linux38 selected PASS; fresh native Codex2/Claude2 control tests PASS. Broader regression88 PASS/2 obsolete-fixture FAIL; corrected affected suites21 PASS. Milestone ready for commit. See P07_EFFECTIVE_CONTROL_CONTRACTS.md and P08_CAPTURE_PROJECTION_ISOLATION.md. Full capabilities, cutover/backup, immutable full regression and P12 remain pending. Pi and dedicated attach native NOT_RUN. Final gate NOT PASSED.
