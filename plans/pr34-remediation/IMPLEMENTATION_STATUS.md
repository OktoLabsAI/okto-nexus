...
Current resume point (2026-09-23): bffb03f pushed. Claude version contract unit above it adds bounded owned executable probing and exact native request matching. Local Claude updated to2.1.281: correct initial rejection, isolated qualification2 PASS and mandatory-profile denial/question2 PASS. Windows122 PASS; Linux39 PASS; surface46/identity13/schema056. See P07_CLAUDE_VERSION_CONTRACT.md. Full effective capabilities, remaining admin parity/cutover/backup and P12 immutable-SHA regression/native advanced campaigns remain pending. Pi and dedicated attach native NOT_RUN. Final gate NOT PASSED.
