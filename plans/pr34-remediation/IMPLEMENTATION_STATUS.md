...
Current resume point (2026-09-23): migration 048, surface revision 38. Claude native approval checkpoint 6cb0f89 committed and pushed. Explicit profile required_native_requests now denies unmet contracts or disabled HITL across open, conversation planning, managed claim and construction; compatible paths and logical inbox preserved. See P09_PROFILE_REQUIREMENTS.md: new suite Windows/Linux each 8 PASS, legacy/surface 71 PASS; expanded results include one corrected test-only optional-field expectation. Next: native input/elicitation integration and remaining P09 gates, P10 causality, P11 administration/UI, P12 full matrix/build/install. Codex and Claude real binary denial already proved in preceding checkpoints. Pi/attach native remain NOT_RUN. Final gate NOT PASSED.
