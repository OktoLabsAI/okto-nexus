...
Current resume point (2026-09-23): whole-process P10 restart coverage on parent 6b03ba9, migration 052 unchanged. Five cases PASS on Windows and Linux: fsynced terminal recovery, committed child recovery, ambiguous acceptance without replay, expired result without execution, and slow chain across four owners. See P10_PROCESS_RESTART.md for commands, fixture failures and limits. Additional correlation/causality/notification regression: Windows 55 PASS, Linux 55 PASS; separate three-agent chain 1 PASS each. T-RELAY-01/02/03/05/08/10 and T-JRN-02 PASS; no phase VERIFIED. Next: remaining P10 correlation/target matrix, P11/P12 and build/install. Native relay NOT_RUN. Final gate NOT PASSED.
