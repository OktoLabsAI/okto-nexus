...
Current resume point (2026-09-23): 8e7888a pushed (effective controls and durable capture isolation). Production multiplex milestone above it closes the gap between injected shared-peer tests and normal factory openings. Exact approved context controls reuse, with atomic lifecycle scope acquisition. Windows31/Linux31 PASS; real Codex0.156.1 multiplex1 PASS (three durable results, sibling survival and final observed stop). Surface49/identity16/schema056. See P07_PRODUCTION_MULTIPLEX.md. Broader effective capabilities, cutover/backup, immutable full regression and P12 remain pending. Pi and dedicated attach native NOT_RUN. Final gate NOT PASSED.
