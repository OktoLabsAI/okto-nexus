...
Current resume point (2026-09-23): 90f673e pushed (Claude bounded version requirements). Attach protocol contract unit above it now rejects missing/null/boolean/float peerProtocol and revalidates exact integer1 before send. Five behavior REDs corrected; Linux97 PASS including authenticated real Unix-socket composition, Windows75 PASS plus17 PASS/9 POSIX skips. Surface47/identity14/schema056. See P07_ATTACH_PROTOCOL_CONTRACT.md. Full effective capabilities/control negotiation for other adapters, admin parity/cutover/backup and P12 full regression/native advanced campaigns remain pending. Pi and dedicated attach native NOT_RUN. Final gate NOT PASSED.
