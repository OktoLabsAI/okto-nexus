// MessageDetailModal — full metadata + per-recipient delivery lanes + the
// complete body of a single message. Opened by clicking a row in MessagesView
// (which loads the list with include_body=true, so the body is already present).
